document.addEventListener('DOMContentLoaded', () => {
    ...
    const malwareData = [
        {
            ...
            enlace: 'https://www.virustotal.com/gui/file/...'
        },
        {
            id: 2,
            nombre: 'NjRAT',
        ...
        },
        {
            ...
            enlace: 'https://www.welivesecurity.com/rootkits/'
        },
        {
            id: 4,
            ...
            enlace: 'https://www.crowdstrike.com/fileless-malware/'
        },
        {
            id: 5,
            ...
            enlace: 'https://www.kaspersky.com/wannacry'
        },
        {
            id: 6,
            nombre: 'LockBit 3.0',
            ...
            enlace: 'https://www.trendmicro.com/lockbit'
        },
        {
            id: 7,
        ...
        },
        {
            ...
            enlace: 'https://www.symantec.com/stuxnet'
        }
    ];
    ...
    function renderCards(tipoFiltro = 'todos', busqueda = '') {
        ...
        if (filtrados.length === 0) {
            grid.innerHTML = `<div class="no-results" style="grid-column:1/-1; text-align:center; padding:3rem; color:#7c8db0; background:#101827; border-radius:2rem; border:1px solid #1f2a42;">
        ...
        <div class="card" style="animation-delay: ${0.04 * (idx % 8)}s">
          ...
          ${recursos.length > 0 ? `<div class="multimedia">
          ...
          ${item.enlace ? `<a href="${item.enlace}" target="_blank" class="enlace-externo"><i class="fas fa-external-link-alt"></i> Más información</a>` : ''}
        </div>
      `;
        });
    ...
    filtros.forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            renderCards(tipo, searchInput.value);
        });
    });
